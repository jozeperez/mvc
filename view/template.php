...
<head>
	...
	<link rel="stylesheet" href="<?=$this->config->item( 'base_url' )?>css/styles.css" type="text/css" media="screen" />
...
?>
	...
	<section id="main"><!-- #main content and sidebar area -->
			<section id="content"><!-- #content -->
        		...
        		<article>
							<h3><a href="#">Widgets you can rely on</a></h3>
        		...
        		<article>
							<h3><a href="#">Winning widgets</a></h3>

					<img src="<?=$this->config->item( 'base_url' )?>images/product.gif" alt="" />
                    <img src="<?=$this->config->item( 'base_url' )?>images/product.gif" alt="" />
                    <img src="<?=$this->config->item( 'base_url' )?>images/product.gif" alt="" />
                    <img src="<?=$this->config->item( 'base_url' )?>images/product.gif" alt="" />
                    <br /><br />
        ...
        <h1>Woody Widgets</h1>
           ...
           <img src="<?=$this->config->item( 'base_url' )?>images/logo.gif" alt="" />  <br> <br>
